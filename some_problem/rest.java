...
class Resturent  {
    ...
    Resturent () {
        ...
        JLabel l0 = new JLabel("Restaurant Menu");
        ...
        c41.setBounds(700, 150, 200, 50);
        c42.setBounds(700, 200, 150, 50);
        c43.setBounds(700, 250, 150, 50);
        c44.setBounds(700, 300, 150, 50);
        c45.setBounds(700, 350, 150, 50);

//        totalCostLabel = new JLabel("Total Cost: ৳" + tcost);
//        totalCostLabel.setBounds(400, 500, 150, 50);
//        f.add(totalCostLabel);
        ...
        c11.addItemListener(itemListener);
        c12.addItemListener(itemListener);
        c13.addItemListener(itemListener);
        c14.addItemListener(itemListener);
        c15.addItemListener(itemListener);

        c21.addItemListener(itemListener);
        c22.addItemListener(itemListener);
        c23.addItemListener(itemListener);
        c24.addItemListener(itemListener);
        c25.addItemListener(itemListener);

        c31.addItemListener(itemListener);
        c32.addItemListener(itemListener);
        c33.addItemListener(itemListener);
        c34.addItemListener(itemListener);
        c35.addItemListener(itemListener);

        c41.addItemListener(itemListener);
        c42.addItemListener(itemListener);
        c43.addItemListener(itemListener);
        c44.addItemListener(itemListener);
        c45.addItemListener(itemListener);
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(f, "Order has been placed.\n Total cost of Item : " + tcost);
            }
        });
    ...
    private void updateTotalCostLabel() {
        totalCostLabel.setText("Total Cost: ৳" + tcost);
        totalCostLabel.repaint();
    }
    

  
    private double parseCost(String text) {
        try {
            
            String costString = text.split(" ")[2].replace("৳", "");
